...
class TestCorpus(unittest.TestCase):
    ...
    def test_feature_joins_1(self):
        ...
        self.assertListEqual(l1, ["LEFT JOIN Lexicon AS COQ_WORD_1 ON COQ_WORD_1.WordId = COQ_CORPUS_1.WordId"])
        self.assertListEqual(l2, [])

    def test_feature_joins_2(self):
        l1, l2 = self.resource.get_feature_joins(1, ["word_label"])
        self.assertListEqual(l1, ["LEFT JOIN Lexicon AS COQ_WORD_2 ON COQ_WORD_2.WordId = COQ_CORPUS_2.WordId"])
        self.assertListEqual(l2, [])
    ...
    def test_feature_joins_4(self):
        ...
        self.assertListEqual(l1, ["LEFT JOIN Lexicon AS COQ_WORD_1 ON COQ_WORD_1.WordId = COQ_CORPUS_1.WordId",
                                  "LEFT JOIN Lemmas AS COQ_LEMMA_1 ON COQ_LEMMA_1.LemmaId = COQ_WORD_1.LemmaId"])
        self.assertListEqual(l2, [])
    ...
    def test_feature_joins_4a(self):
        ...
        l1b, l2b = self.resource.get_feature_joins(0, ["lemma_label", "word_label"])
    ...
    #def test_query_string_1(self):
        #query = TokenQuery("*", self.Session)
        #query_string = self.resource.get_query_string(query.query_list[0], ["word_label"])
        #print(query_string)
    ...
    #def test_query_string_3(self):
        ...
        #query_string = self.resource.get_query_string(query.query_list[0], ["word_label", "word_pos", "lemma_label"],)
        #print(query_string)
    ...
    #def test_query_string_5(self):
        #query = TokenQuery("a* b*", self.Session)
        #query_string = self.resource.get_query_string(query.query_list[0], ["word_label", "segment_label"],)
        #print(query_string)

    #def test_quantified_query_string_5(self):
        #query = TokenQuery("* b{1,2} *", self.Session)
        #self.assertTrue(len(query.query_list) == 2)
        #self.assertTrue(len(query.query_list[0]) == len(query.query_list[1]))
        #query_string = self.resource.get_query_string(query.query_list[0], ["word_label", "segment_label"],)
        #print(query_string)
