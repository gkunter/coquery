...
class Ui_ConnectionConfig(object):
    def setupUi(self, ConnectionConfig):
        ...
        ConnectionConfig.resize(810, 724)
        self.verticalLayout_5 = QtGui.QVBoxLayout(ConnectionConfig)
        ...
        self.frame_sqlite = QtGui.QFrame(self.frame_settings)
        ...
        self.label_8 = QtGui.QLabel(self.frame_sqlite)
        ...
        self.layout_settings.addWidget(self.frame_sqlite)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 354, 72))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.MinimumExpanding, QtGui.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.layout_settings.setStretch(4, 1)
        ...
        self.label_8.setBuddy(self.input_db_path)
        ...
        ConnectionConfig.setTabOrder(self.tree_configuration, self.button_status)
        ConnectionConfig.setTabOrder(self.button_status, self.scrollArea)
    ...
    def retranslateUi(self, ConnectionConfig):
        ...
        self.label_5.setText(_translate("ConnectionConfig", "&Available connections:", None))
        ...
        self.label_8.setText(_translate("ConnectionConfig", "&Database directory:", None))
        ...
        self.radio_remote.setText(_translate("ConnectionConfig", "&Remote server on the network:", None))
