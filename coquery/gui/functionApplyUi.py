...
#
# Created: Tue Sep  8 23:25:11 2015
...
class Ui_FunctionDialog(object):
    def setupUi(self, FunctionDialog):
        ...
        self.gridLayout.addWidget(self.radio_regexp, 4, 0, 1, 1)
        self.radio_length = QtGui.QRadioButton(self.frame1)
        self.radio_length.setChecked(True)
    ...
    def retranslateUi(self, FunctionDialog):
        ...
        self.label_3.setText(_translate("FunctionDialog", "<html><head/><body><p>Match the parameter as a <a href=\"https://docs.python.org/2/howto/regex.html\"><span style=\" text-decoration: underline; color:#0057ae;\">regular expression</span></a></p></body></html>", None))
        self.label_2.setText(_translate("FunctionDialog", "Count the number of characters", None))
        ...
        self.label.setText(_translate("FunctionDialog", "Count the occurrences of the parameter", None))
