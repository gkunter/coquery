...
#
# Created: Sun Sep  6 16:12:23 2015
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.box_query_mode = QtGui.QFrame(self.options_area)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.box_query_mode.sizePolicy().hasHeightForWidth())
        self.box_query_mode.setSizePolicy(sizePolicy)
        ...
        self.horizontalLayout_8 = QtGui.QHBoxLayout(self.box_query_mode)
        self.horizontalLayout_8.setSpacing(16)
        self.horizontalLayout_8.setContentsMargins(8, 6, 8, 6)
        self.horizontalLayout_8.setObjectName(_fromUtf8("horizontalLayout_8"))
        self.label_10 = QtGui.QLabel(self.box_query_mode)
        ...
        self.radio_mode_tokens.setChecked(True)
        self.radio_mode_tokens.setObjectName(_fromUtf8("radio_mode_tokens"))
        self.verticalLayout_14.addWidget(self.radio_mode_tokens)
        ...
        self.radio_mode_context.setChecked(False)
        self.radio_mode_context.setObjectName(_fromUtf8("radio_mode_context"))
        self.verticalLayout_14.addWidget(self.radio_mode_context)
        ...
        self.verticalLayout_14.addWidget(self.radio_mode_frequency)
        ...
        self.verticalLayout_14.addWidget(self.radio_mode_collocations)
        self.horizontalLayout_8.addLayout(self.verticalLayout_14)
        self.horizontalLayout_8.setStretch(0, 1)
        self.verticalLayout_3.addWidget(self.box_query_mode)
        ...
        self.box_qer_buttons.addWidget(self.progress_bar, 1, 1, 1, 1)
        ...
        self.box_qer_buttons.addWidget(self.button_stopwords, 0, 0, 1, 1)
        spacerItem3 = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.box_qer_buttons.addItem(spacerItem3, 0, 1, 1, 1)
        ...
        self.box_qer_buttons.addWidget(self.button_run_query, 1, 0, 1, 1)
        ...
        self.stopword_tab = QtGui.QWidget()
        self.stopword_tab.setEnabled(False)
        self.stopword_tab.setObjectName(_fromUtf8("stopword_tab"))
        self.horizontalLayout_4 = QtGui.QHBoxLayout(self.stopword_tab)
        self.horizontalLayout_4.setObjectName(_fromUtf8("horizontalLayout_4"))
        self.horizontalLayout_3 = QtGui.QHBoxLayout()
        self.horizontalLayout_3.setSpacing(20)
        self.horizontalLayout_3.setObjectName(_fromUtf8("horizontalLayout_3"))
        self.stopword_list = QtGui.QListWidget(self.stopword_tab)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.horizontalLayout_3.addWidget(self.stopword_list)
        self.verticalLayout_6 = QtGui.QVBoxLayout()
        self.verticalLayout_6.setSpacing(0)
        self.verticalLayout_6.setObjectName(_fromUtf8("verticalLayout_6"))
        self.button_stopword_load = QtGui.QPushButton(self.stopword_tab)
        icon = QtGui.QIcon.fromTheme(_fromUtf8("document-open"))
        self.button_stopword_load.setIcon(icon)
        self.button_stopword_load.setObjectName(_fromUtf8("button_stopword_load"))
        self.verticalLayout_6.addWidget(self.button_stopword_load)
        self.button_stopword_save = QtGui.QPushButton(self.stopword_tab)
        ...
        self.verticalLayout_6.addWidget(self.button_stopword_save)
        ...
        self.label_3 = QtGui.QLabel(self.stopword_tab)
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.verticalLayout_10.addWidget(self.label_3)
        self.edit_stopword = QtGui.QLineEdit(self.stopword_tab)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.edit_stopword.sizePolicy().hasHeightForWidth())
        self.edit_stopword.setSizePolicy(sizePolicy)
        self.edit_stopword.setObjectName(_fromUtf8("edit_stopword"))
        self.verticalLayout_10.addWidget(self.edit_stopword)
        self.button_stopword_remove = QtGui.QPushButton(self.stopword_tab)
        self.button_stopword_remove.setObjectName(_fromUtf8("button_stopword_remove"))
        self.verticalLayout_10.addWidget(self.button_stopword_remove)
        self.verticalLayout_6.addLayout(self.verticalLayout_10)
        self.horizontalLayout_3.addLayout(self.verticalLayout_6)
        self.horizontalLayout_3.setStretch(0, 1)
        self.horizontalLayout_4.addLayout(self.horizontalLayout_3)
        self.tabbed_views.addTab(self.stopword_tab, _fromUtf8(""))
...
"summary:", None))
        self.radio_mode_tokens.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">Do not summarize the rquery results.</span></p><p>Every token that matches the query string is listed in the \'Query results\' table. </p></body></html>", None))
        self.radio_mode_tokens.setText(_translate("MainWindow", "No summary", None))
        self.radio_mode_context.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">Show only distinct tokens.</span></p><p>The tokens matching the query string are summarized so that duplicate matches are dropped. The \'Query results\' table shows only distinct tokens, and no duplicates. </p></body></html>", None))
        self.radio_mode_context.setText(_translate("MainWindow", "Distinct tokens", None))
        self.radio_mode_frequency.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">Show the frequency of each token.</span></p><p>\n"
"The number of occurrences of each token matching the query string is counted. The \'Query results\' table shows one row for each token, with the number of occurrences in the column \'Frequency\' . </p></body></html>", None))
        ...
        self.button_stopword_load.setText(_translate("MainWindow", "Load stop-words", None))
        self.button_stopword_save.setText(_translate("MainWindow", "Save stop-words", None))
        self.label_3.setText(_translate("MainWindow", "Add stop word:", None))
        self.button_stopword_remove.setText(_translate("MainWindow", "Remove", None))
        self.tabbed_views.setTabText(self.tabbed_views.indexOf(self.stopword_tab), _translate("MainWindow", "Stop-words", None))
