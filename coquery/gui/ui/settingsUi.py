...
class Ui_SettingsDialog(object):
    def setupUi(self, SettingsDialog):
        ...
        self.check_regular_expressions = QtWidgets.QCheckBox(self.Queries)
        self.check_regular_expressions.setObjectName("check_regular_expressions")
        self.verticalLayout_2.addWidget(self.check_regular_expressions)
        self.check_regular_expressions1 = QtWidgets.QCheckBox(self.Queries)
        self.check_regular_expressions1.setObjectName("check_regular_expressions1")
        self.verticalLayout_2.addWidget(self.check_regular_expressions1)
        self.check_ignore_case_query = QtWidgets.QCheckBox(self.Queries)
        self.check_ignore_case_query.setObjectName("check_ignore_case_query")
        self.verticalLayout_2.addWidget(self.check_ignore_case_query)
        self.check_drop_empty_queries = QtWidgets.QCheckBox(self.Queries)
        self.check_drop_empty_queries.setObjectName("check_drop_empty_queries")
        self.verticalLayout_2.addWidget(self.check_drop_empty_queries)
        self.check_align_quantified = QtWidgets.QCheckBox(self.Queries)
        self.check_align_quantified.setObjectName("check_align_quantified")
        self.verticalLayout_2.addWidget(self.check_align_quantified)
        self.line = QtWidgets.QFrame(self.Queries)
        self.line.setFrameShape(QtWidgets.QFrame.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.verticalLayout_2.addWidget(self.line)
        self.widget_cache = QtWidgets.QWidget(self.Queries)
    ...
    def retranslateUi(self, SettingsDialog):
        ...
        self.label_3.setText(_translate("SettingsDialog", "&Display "))
        ...
        self.check_regular_expressions1.setText(_translate("SettingsDialog", "Interpret queries as &regular expressions"))
        ...
        self.check_use_cache.setText(_translate("SettingsDialog", "Use query &cache, size: "))
