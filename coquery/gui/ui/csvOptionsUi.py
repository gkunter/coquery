...
class Ui_FileOptions(object):
    def setupUi(self, FileOptions):
        ...
        self.combo_encoding.setMaxVisibleItems(7)
        self.combo_encoding.setMinimumContentsLength(0)
        ...
        self.spin_nrows.setMaximum(9999)
    ...
    def retranslateUi(self, FileOptions):
        ...
        self.label_6.setText(_translate("FileOptions", "Number of &lines to ignore after header:"))
        ...
        self.ignore_lines.setSpecialValueText(_translate("FileOptions", "none"))
        ...
        self.spin_nrows.setSpecialValueText(_translate("FileOptions", "all"))
        self.label_5.setText(_translate("FileOptions", "&Number of lines to read after header and ignored lines:"))
