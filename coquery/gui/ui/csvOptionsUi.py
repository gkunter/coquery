...
class Ui_FileOptions(object):
    def setupUi(self, FileOptions):
        ...
        self.gridLayout.addWidget(self.query_column, 0, 1, 1, 1)
        ...
        self.separate_char.addItem(_fromUtf8(""))
        self.separate_char.addItem(_fromUtf8(""))
        self.gridLayout.addWidget(self.separate_char, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.combo_encoding, 5, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_query_column, 0, 0, 1, 1)
