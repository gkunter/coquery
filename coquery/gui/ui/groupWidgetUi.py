...
class Ui_GroupWidget(object):
    def setupUi(self, GroupWidget):
        ...
        self.gridLayout = QtWidgets.QGridLayout(GroupWidget)
        ...
        self.gridLayout.addWidget(self.tree_groups, 0, 0, 4, 4)
        ...
        self.gridLayout.addWidget(self.button_group_up, 1, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_group_down, 2, 4, 1, 1)
