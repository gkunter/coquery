...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame_aggregation = QtGui.QFrame(self.frame)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_10.setBuddy(self.frame_aggregation)
...
"The number of occurrences of each token matching the query string is counted. The \'Query results\' table shows one row for each token, with the number of occurrences in the column \'Frequency\' . </p></body></html>", None))
        ...
        self.action_toggle_filters.setText(_translate("MainWindow", "Toggle &filters", None))
        self.action_toggle_stopwords.setText(_translate("MainWindow", "Toggle stop&words", None))
