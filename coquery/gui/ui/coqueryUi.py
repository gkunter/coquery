...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        spacerItem2 = QtGui.QSpacerItem(101, 0, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.box_qer_buttons.addItem(spacerItem2, 0, 1, 1, 1)
