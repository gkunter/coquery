...
class Ui_LinkSelect(object):
    def setupUi(self, LinkSelect):
        ...
        self.group_current_corpus = QtGui.QGroupBox(LinkSelect)
        self.group_current_corpus.setObjectName(_fromUtf8("group_current_corpus"))
        self.gridLayout_2 = QtGui.QGridLayout(self.group_current_corpus)
        ...
        self.label_from_corpus = QtGui.QLabel(self.group_current_corpus)
        ...
        self.group_external_corpus = QtGui.QGroupBox(LinkSelect)
        self.group_external_corpus.setObjectName(_fromUtf8("group_external_corpus"))
        self.gridLayout = QtGui.QGridLayout(self.group_external_corpus)
        ...
        self.combo_corpus = QtGui.QComboBox(self.group_external_corpus)
    ...
    def retranslateUi(self, LinkSelect):
        ...
        self.group_current_corpus.setTitle(_translate("LinkSelect", "&Current corpus", None))
        ...
        self.group_external_corpus.setTitle(_translate("LinkSelect", "E&xternal corpus", None))
