...
class Ui_NamedTableOptions(object):
    def setupUi(self, NamedTableOptions):
        ...
        self.gridLayout_2.addWidget(self.FilePreviewArea, 2, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.combo_encoding, 7, 1, 1, 1)
        self.quote_char = QtWidgets.QComboBox(self.OptionsBox)
        self.quote_char.setObjectName("quote_char")
        self.gridLayout.addWidget(self.quote_char, 6, 1, 1, 1)
        ...
        self.label_5 = QtWidgets.QLabel(self.OptionsBox)
        self.label_5.setObjectName("label_5")
        self.gridLayout.addWidget(self.label_5, 5, 0, 1, 1)
        self.spin_nrows = QtWidgets.QSpinBox(self.OptionsBox)
        self.spin_nrows.setObjectName("spin_nrows")
        self.gridLayout.addWidget(self.spin_nrows, 5, 1, 1, 1)
        ...
        self.group_mappings = QtWidgets.QGroupBox(NamedTableOptions)
        self.group_mappings.setObjectName("group_mappings")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.group_mappings)
        self.verticalLayout.setContentsMargins(9, 9, 9, 9)
        self.verticalLayout.setSpacing(0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.layout_name_buttons = QtWidgets.QGridLayout()
        self.layout_name_buttons.setHorizontalSpacing(4)
        self.layout_name_buttons.setVerticalSpacing(6)
        self.layout_name_buttons.setObjectName("layout_name_buttons")
        self.edit_map_gloss = QtWidgets.QLineEdit(self.group_mappings)
        self.edit_map_gloss.setReadOnly(True)
        self.edit_map_gloss.setObjectName("edit_map_gloss")
        self.layout_name_buttons.addWidget(self.edit_map_gloss, 4, 1, 1, 1)
        self.button_map_lemma = QtWidgets.QPushButton(self.group_mappings)
        self.button_map_lemma.setObjectName("button_map_lemma")
        self.layout_name_buttons.addWidget(self.button_map_lemma, 1, 0, 1, 1)
        self.edit_map_word = QtWidgets.QLineEdit(self.group_mappings)
        self.edit_map_word.setReadOnly(True)
        self.edit_map_word.setObjectName("edit_map_word")
        self.layout_name_buttons.addWidget(self.edit_map_word, 0, 1, 1, 1)
        self.button_map_word = QtWidgets.QPushButton(self.group_mappings)
        self.button_map_word.setObjectName("button_map_word")
        self.layout_name_buttons.addWidget(self.button_map_word, 0, 0, 1, 1)
        self.button_map_pos = QtWidgets.QPushButton(self.group_mappings)
        self.button_map_pos.setObjectName("button_map_pos")
        self.layout_name_buttons.addWidget(self.button_map_pos, 2, 0, 1, 1)
        self.edit_map_lemma = QtWidgets.QLineEdit(self.group_mappings)
        self.edit_map_lemma.setReadOnly(True)
        self.edit_map_lemma.setObjectName("edit_map_lemma")
        self.layout_name_buttons.addWidget(self.edit_map_lemma, 1, 1, 1, 1)
        self.button_map_transcript = QtWidgets.QPushButton(self.group_mappings)
        self.button_map_transcript.setObjectName("button_map_transcript")
        self.layout_name_buttons.addWidget(self.button_map_transcript, 3, 0, 1, 1)
        self.button_map_gloss = QtWidgets.QPushButton(self.group_mappings)
        self.button_map_gloss.setObjectName("button_map_gloss")
        self.layout_name_buttons.addWidget(self.button_map_gloss, 4, 0, 1, 1)
        self.edit_map_transcript = QtWidgets.QLineEdit(self.group_mappings)
        self.edit_map_transcript.setReadOnly(True)
        self.edit_map_transcript.setObjectName("edit_map_transcript")
        self.layout_name_buttons.addWidget(self.edit_map_transcript, 3, 1, 1, 1)
        self.edit_map_pos = QtWidgets.QLineEdit(self.group_mappings)
        self.edit_map_pos.setReadOnly(True)
        self.edit_map_pos.setObjectName("edit_map_pos")
        self.layout_name_buttons.addWidget(self.edit_map_pos, 2, 1, 1, 1)
        ...
        self.verticalLayout_4.addWidget(self.group_mappings)
        ...
        self.label_5.setBuddy(self.spin_nrows)
    ...
    def retranslateUi(self, NamedTableOptions):
        ...
        self.label_5.setText(_translate("NamedTableOptions", "&Maximum lines to read:"))
        self.group_mappings.setTitle(_translate("NamedTableOptions", "Query type mappings"))
        self.button_map_lemma.setText(_translate("NamedTableOptions", "Lemma"))
        self.button_map_word.setText(_translate("NamedTableOptions", "Word"))
        self.button_map_pos.setText(_translate("NamedTableOptions", "POS"))
        self.button_map_transcript.setText(_translate("NamedTableOptions", "Transcript"))
        self.button_map_gloss.setText(_translate("NamedTableOptions", "Gloss"))
