...
class Ui_ConnectionConfig(object):
    def setupUi(self, ConnectionConfig):
        ...
        ConnectionConfig.resize(705, 825)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 359, 93))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.MinimumExpanding, QtGui.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, ConnectionConfig):
        ...
        self.label_5.setText(_translate("ConnectionConfig", "<html><head/><body><p><span style=\" font-weight:600;\">Database connections</span></p><p>&amp;Available connections:</p></body></html>", None))
