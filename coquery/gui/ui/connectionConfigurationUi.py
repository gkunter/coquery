...
class Ui_ConnectionConfig(object):
    def setupUi(self, ConnectionConfig):
        ...
        self.configuration_name = QtWidgets.QLineEdit(self.group_general)
        ...
        self.gridLayout_4.addWidget(self.configuration_name, 0, 1, 1, 2)
        self.label_7 = QtWidgets.QLabel(self.group_general)
        ...
        self.gridLayout_4.addWidget(self.radio_mysql, 1, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.radio_sqlite, 1, 2, 1, 1)
    ...
    def retranslateUi(self, ConnectionConfig):
        ...
        self.configuration_name.setPlaceholderText(_translate("ConnectionConfig", "(untitled)"))
