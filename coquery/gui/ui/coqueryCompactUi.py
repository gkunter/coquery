...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.box_qer_buttons.setHorizontalSpacing(4)
        self.box_qer_buttons.setVerticalSpacing(2)
        ...
        self.output_columns.setContentsMargins(4, 0, 4, 0)
        ...
        self.box_aggregation_mode.setFrameShape(QtGui.QFrame.NoFrame)
        ...
        self.actionCopy_results_to_clipboard = QtGui.QAction(MainWindow)
        icon = QtGui.QIcon.fromTheme(_fromUtf8("edit-copy"))
        self.actionCopy_results_to_clipboard.setIcon(icon)
        self.actionCopy_results_to_clipboard.setObjectName(_fromUtf8("actionCopy_results_to_clipboard"))
        ...
        self.menuFile.addAction(self.actionCopy_results_to_clipboard)
...
"The number of occurrences of each token matching the query string is counted. The \'Query results\' table shows one row for each token, with the number of occurrences in the column \'Frequency\' . </p></body></html>", None))
        ...
        self.action_connection_settings.setText(_translate("MainWindow", "&MySQL settings...", None))
        ...
        self.actionCopy_results_to_clipboard.setText(_translate("MainWindow", "Copy results to clipboard...", None))
        self.action_bubble_chart.setText(_translate("MainWindow", "Bubble chart", None))
        self.action_mysql_server_help.setText(_translate("MainWindow", "MySQL server guide", None))
