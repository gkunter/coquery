...
class Ui_CorpusInstaller(object):
    def setupUi(self, CorpusInstaller):
        ...
        CorpusInstaller.resize(740, 480)
        ...
        self.button_options = QtGui.QPushButton(self.box_build_options)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        icon = QtGui.QIcon.fromTheme(_fromUtf8("folder"))
        self.button_options.setIcon(icon)
        self.button_options.setObjectName(_fromUtf8("button_options"))
        self.gridLayout.addWidget(self.button_options, 2, 1, 1, 1)
    ...
    def retranslateUi(self, CorpusInstaller):
        ...
        self.button_options.setText(_translate("CorpusInstaller", "Options", None))
        self.button_options.setShortcut(_translate("CorpusInstaller", "Alt+B", None))
