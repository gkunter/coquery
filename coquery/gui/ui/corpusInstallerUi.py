...
class Ui_CorpusInstaller(object):
    def setupUi(self, CorpusInstaller):
        ...
        CorpusInstaller.resize(757, 480)
        ...
        self.gridLayout.addLayout(self.layout_nltk, 4, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.widget_ngram, 5, 0, 1, 1)
        ...
        self.input_path = CoqClickableLabel(self.box_build_options)
    ...
    def retranslateUi(self, CorpusInstaller):
        ...
        self.label_6.setText(_translate("CorpusInstaller", "Only install corpus module, do not install data files (e.g. if you use a network database server)", None))
        self.label_5.setText(_translate("CorpusInstaller", "Install corpus module and data files", None))
