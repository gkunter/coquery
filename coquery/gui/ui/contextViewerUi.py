...
class Ui_ContextView(object):
    def setupUi(self, ContextView):
        ...
        self.label = QtGui.QLabel(self.tab_textgrid)
        self.label.setObjectName(_fromUtf8("label"))
        self.horizontalLayout_3.addWidget(self.label)
        self.spin_dynamic_range = QtGui.QDoubleSpinBox(self.tab_textgrid)
        self.spin_dynamic_range.setMinimum(1.0)
        self.spin_dynamic_range.setProperty("value", 50.0)
        self.spin_dynamic_range.setObjectName(_fromUtf8("spin_dynamic_range"))
        self.horizontalLayout_3.addWidget(self.spin_dynamic_range)
        self.horizontalLayout_2.addLayout(self.horizontalLayout_3)
        self.horizontalLayout_4 = QtGui.QHBoxLayout()
        self.horizontalLayout_4.setObjectName(_fromUtf8("horizontalLayout_4"))
        self.label_2 = QtGui.QLabel(self.tab_textgrid)
        self.label_2.setObjectName(_fromUtf8("label_2"))
        self.horizontalLayout_4.addWidget(self.label_2)
        self.spin_window_length = QtGui.QDoubleSpinBox(self.tab_textgrid)
        ...
        self.spin_window_length.setObjectName(_fromUtf8("spin_window_length"))
    ...
    def retranslateUi(self, ContextView):
        ...
        self.tab_widget.setTabText(self.tab_widget.indexOf(self.tab_context), _translate("ContextView", "Text", None))
        self.label.setText(_translate("ContextView", "&Dynamic range:", None))
        self.spin_dynamic_range.setSuffix(_translate("ContextView", " dB", None))
        self.label_2.setText(_translate("ContextView", "&Window length:", None))
        self.spin_window_length.setSuffix(_translate("ContextView", " s", None))
        self.tab_widget.setTabText(self.tab_widget.indexOf(self.tab_textgrid), _translate("ContextView", "&Audio", None))
