...
class Ui_FunctionDialog(object):
    def setupUi(self, FunctionDialog):
        ...
        self.gridLayout.addWidget(self.label_func4, 6, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_func3, 5, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.radio_regexp, 6, 0, 1, 1)
        self.radio_match = QtGui.QRadioButton(self.frame1)
        self.radio_match.setObjectName(_fromUtf8("radio_match"))
        self.gridLayout.addWidget(self.radio_match, 5, 0, 1, 1)
        ...
        self.radio_copy = QtGui.QRadioButton(self.frame1)
        self.radio_copy.setObjectName(_fromUtf8("radio_copy"))
        self.gridLayout.addWidget(self.radio_copy, 4, 0, 1, 1)
        self.label_copy = QtGui.QLabel(self.frame1)
        self.label_copy.setWordWrap(True)
        self.label_copy.setObjectName(_fromUtf8("label_copy"))
        self.gridLayout.addWidget(self.label_copy, 4, 1, 1, 1)
    ...
    def retranslateUi(self, FunctionDialog):
        ...
        self.radio_copy.setText(_translate("FunctionDialog", "COP&Y", None))
        self.label_copy.setText(_translate("FunctionDialog", "Create a copy of \'{}\'. Copies are not considered corpus features when calculating the size of subcorpora.", None))
