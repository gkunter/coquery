...
class Ui_FunctionDialog(object):
    def setupUi(self, FunctionDialog):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.radio_count.sizePolicy().hasHeightForWidth())
        self.radio_count.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_func2.sizePolicy().hasHeightForWidth())
        self.label_func2.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.radio_regexp.sizePolicy().hasHeightForWidth())
        self.radio_regexp.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.radio_match.sizePolicy().hasHeightForWidth())
        self.radio_match.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.radio_copy.sizePolicy().hasHeightForWidth())
        self.radio_copy.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_copy.sizePolicy().hasHeightForWidth())
        self.label_copy.setSizePolicy(sizePolicy)
    ...
    def retranslateUi(self, FunctionDialog):
        ...
        self.label_func4.setText(_translate("FunctionDialog", "<html><head/><body><p>Match the column with the parameter as a <a href=\"https://docs.python.org/2/howto/regex.html\"><span style=\" text-decoration: underline; color:#0057ae;\">regular expression</span></a>, and show the matching string.</p></body></html>", None))
        self.label_func3.setText(_translate("FunctionDialog", "<html><head/><body><p>Show \'yes\' if the parameter matches the column as a <a href=\"https://docs.python.org/2/howto/regex.html\"><span style=\" text-decoration: underline; color:#0057ae;\">regular expression</span></a>, otherwise \'no\'</p></body></html>", None))
        self.label_func2.setText(_translate("FunctionDialog", "Count the number of characters of in the column.", None))
        self.label_func1.setText(_translate("FunctionDialog", "Count the occurrences of the parameter within the column.\'", None))
        ...
        self.label_copy.setText(_translate("FunctionDialog", "Create a copy of the column. Copies are not considered corpus features when calculating the size of subcorpora.", None))
