...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.group_aggregation.setFrameShape(QtGui.QFrame.NoFrame)
        self.group_aggregation.setFrameShadow(frameShadow)
        ...
        self.radio_aggregate_contrasts = QtGui.QRadioButton(self.group_aggregation)
        self.radio_aggregate_contrasts.setObjectName(_fromUtf8("radio_aggregate_contrasts"))
        self.verticalLayout_2.addWidget(self.radio_aggregate_contrasts)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radio_aggregate_none.setText(_translate("MainWindow", "No aggregation", None))
...
"The number of occurrences of each token matching the query string is counted. The \'Query results\' table shows one row for each token, with the number of occurrences in the column \'Frequency\' . </p></body></html>", None))
        ...
        self.radio_aggregate_contrasts.setText(_translate("MainWindow", "G-test matrix", None))
