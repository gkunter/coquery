...
class Ui_TextgridExport(object):
    def setupUi(self, TextgridExport):
        ...
        TextgridExport.resize(640, 568)
        self.verticalLayout_4 = QtGui.QVBoxLayout(TextgridExport)
        ...
        self.list_columns = QtGui.QListWidget(self.groupBox1)
        ...
        self.radio_one_per_match = QtGui.QRadioButton(self.groupBox2)
        ...
        self.radio_one_per_file = QtGui.QRadioButton(self.groupBox2)
        ...
        self.groupBox3 = QtGui.QGroupBox(TextgridExport)
        self.groupBox3.setObjectName(_fromUtf8("groupBox3"))
        self.gridLayout = QtGui.QGridLayout(self.groupBox3)
        self.gridLayout.setObjectName(_fromUtf8("gridLayout"))
        self.label_4 = QtGui.QLabel(self.groupBox3)
        self.label_4.setObjectName(_fromUtf8("label_4"))
        self.gridLayout.addWidget(self.label_4, 0, 1, 1, 1)
        self.check_copy_sounds = QtGui.QCheckBox(self.groupBox3)
        ...
        self.spin_left_padding = QtGui.QDoubleSpinBox(self.groupBox3)
        ...
        self.label_5 = QtGui.QLabel(self.groupBox3)
        self.label_5.setObjectName(_fromUtf8("label_5"))
        self.horizontalLayout_3.addWidget(self.label_5)
        spacerItem2 = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.horizontalLayout_3.addItem(spacerItem2)
        self.spin_right_padding = QtGui.QDoubleSpinBox(self.groupBox3)
        ...
        self.label_6 = QtGui.QLabel(self.groupBox3)
        ...
        self.edit_sound_path = QtGui.QLineEdit(self.groupBox3)
        ...
        self.button_sound_path = QtGui.QPushButton(self.groupBox3)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.check_remember = QtGui.QCheckBox(self.groupBox3)
    ...
    def retranslateUi(self, TextgridExport):
        ...
        self.groupBox.setTitle(_translate("TextgridExport", "Text grid files", None))
        ...
        self.groupBox1.setTitle(_translate("TextgridExport", "Column selection", None))
        self.groupBox2.setTitle(_translate("TextgridExport", "Text grid creation", None))
        ...
        self.groupBox3.setTitle(_translate("TextgridExport", "Copy sound files", None))
        ...
        self.label_3.setText(_translate("TextgridExport", "Sound fi&le path:", None))
