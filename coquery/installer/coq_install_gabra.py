    ...
    def __init__(self, gui=False, *args):
        ...
        self.create_table_description(self.lemma_table,
            [Primary(self.lemma_id, "SMALLINT(5) UNSIGNED NOT NULL"),
             Column(self.lemma_label, "TINYTEXT NOT NULL", index_length=8),
             ...
             Column(self.lemma_gloss, "TEXT NOT NULL", index_length=12), 
        ...
        self.create_table_description(self.corpus_table,
            [Primary(self.corpus_id, "MEDIUMINT(7) UNSIGNED NOT NULL"),
             Column(self.corpus_word, "TINYTEXT NOT NULL", index_length=15),
