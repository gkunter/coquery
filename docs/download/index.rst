...
The current version of Coquery is 0.9.3. This version is fully functional, and 
...
.. raw:: html
    ...
    <p>Windows installer: <code>coquery-0.9.3-setup-win32.exe</code> <a href="coquery-0.9.2-setup-win32.exe" class="btn btn-primary btn-sm">Download</a></p>
...
.. raw:: html
    ...
    <p>Mac OS X disk image: <code>coquery-0.9.3-osx-el-capitan.dmg</code> <a href="coquery-0.9.2-osx-el-capitan.dmg" class="btn btn-primary btn-sm">Download</a></p>
